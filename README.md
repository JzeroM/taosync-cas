...
TaoSync-CAS​ 是在[原版 TaoSync](https://github.com/dr34m-cn/taosync) 基础上魔改同步逻辑的版本，专门设计用于配合[魔改的OpenList](https://github.com/GitYuA/OpenList-CAS)，实现自动化搬运视频资源到天翼云盘且删除原文件仅保留CAS文件的工作流。
